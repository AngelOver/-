            ...
            <form action="${pageContext.request.contextPath }/user/login.do" method="post" onsubmit="">
             <input type="hidden" name="method" value="userLogin">
                <div class="from-group">
                    <input type="text" name="username" value="tom" class="from-control" placeholder="用户名"  style="width: 420px;height: 55px">
                </div>
                <div class="from-group">
                    <input type="password" name="password" value="123" class="from-control" placeholder="密码"  style="width: 420px;height: 55px">
                </div>
                ...
                <div class="from-group1">
                    <a  class="a3" href="user_reg.jsp">还没账户，马上注册(tom 123)</a>
