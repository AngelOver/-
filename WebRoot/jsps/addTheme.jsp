...
$(function () {
	 $('.message ').css("left",(document.body.clientWidth - $(".message").width())/2+"px");
     $('#content ').css("width",($(".message").width() - 100*2)+"px");
	InitialPage();
...
&nbsp&nbsp;<a href="${pageContext.request.contextPath }/theme/themeList.do">首页</a>;&raquo;&nbsp&nbsp;<a href="#">留言</a>
    ...
    <div class="message">
        ...
        <input type="hidden" name="method" value="save">
            ...
            <div class="from-group20">
                   <textarea  id="content" name="content" class="from-control3" cols=50 rows=6  placeholder="留言" ></textarea>
            </div>
